import type { ClickDebounceOpts } from '$lib/actions/input-debounce.js';
import type { IconContent } from '$lib/Icon/index.js';
import type { SocialColor, SocialRadius, SocialSize } from '$lib/common.js';
